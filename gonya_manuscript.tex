...
%TODO work out transcriptomes Arjun, insert Nanodrop, centrifuge, kit name deets
...
%AD 160118: do you want to give the two parts more descriptive short names? // Better ^___^
...
- not axenic
- no representative genome for comparison
- potential bias in single copy gene selection as based on BUSCO
- assembly problems
- whether scripts are re-usable
- WAG model
- 
