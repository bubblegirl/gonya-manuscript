...
\subsubsection*{rDNA based tree comparison}
%TODO commit seppuku
...
\section{Introduction}
%TODO need to take out any reference to pipeline or software
%TODO new direction of paper - model and data impact on phylogenetics. need to re-write intro
...
%TODO need to take out any reference to pipeline or software
%TODO take out value judgement compared to other studies
%TODO discuss the purely data driven approach not agreeing with morphology, incl. ref FBD-*beast findings
This study presents a data driven, statistically currently adequate method to approach the issue of paralogy for phylogenetics. 
The approach is founded on identifying single copy genes in transcriptomes; extracting and aligning the candidate genes; and running phylogenetic inference. 
%upt ot here
