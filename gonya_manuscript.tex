...
Dinoflagellates represent an ancient lineage on the eukaryotic branch of life \cite{}. 
They play a role in several important ecological processes, as members are represented in aquatic environments, where the cover a diverse niches such as symbionts, parasites and some taxa can cause harmful algal blooms through proliferation and/or neurotoxin production \cite{}.
...
%TODO work out transcriptomes Arjun, insert centrifuge, kit name deets
...
%TODO work out if Arjun or I am describing transcriptomes for \emph{Coolia malayensis} \emph{Ostreopsis ovata}, \emph{Ostreopsis rhodesae}, \emph{Ostreopsis siamensis} 
...
In all five transcriptomes the complete protein coding pathways were present. %TODO what the fuck pathway am I talking about here?
%TODO Interpro scan, mothur, SRA IDs
\FloatBarrier
...
%AD 160118: I thought extant meant currently alive? e.g. contradicts fossils? // Yep, you're right. See, this is why I shouldn't go near fossils. I can't even get the terminology right, let alone dates
...
%AD 160118: this is a bit dodgy. if you want to state this you should back it up with verifiable data.
%TODO find out when that is getting published by Arjun or remove. Also,be less dodgy.
...
%I may have gone on a tangent here. Basically 
What follows is the identification of issues with the approach presented in this study, which the authors hope will be improved upon in the future. 
\subsubsection*{Pipeline specific issues}
\paragraph*{Trimming of RNA seq libraries.} The cut off values chosen for this study are based on the recommendations of MacMannes (2014) for
\paragraph*{Single copy gene selection bias.} Based on BUSCOv2 which may have inherent selection bias that is not tranparent to us 
...
\paragraph*{No representative genome for comparison.} Without a guided genome comparison, it is difficult to extrapolate the assembly adequacy or whether paralogy is 
