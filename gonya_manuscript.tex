...
\subsubsection*{with Maximum Likelihood}

\subsubsection*{with Bayesian inference}

\subsection*{rDNA based tree comparison}
%TODO commit seppuku
Ribosomal DNA sequences for the small subunit region as well as the D1-D3 large subunit region were aquired from NCBI \cite{coordinators2017database} or the SILVA rRNA database project \cite{silvaproj}, accession IDs in Suppl. table 1. Sequences were concatenated in Geneious v11.3 and Maximum Likelihood inference was run the HPCC using RaxML \cite{stamatakis2014raxml} with under the GTR and GAMMA flags.
