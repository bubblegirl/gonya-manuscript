...
Assemblies were searched with BUSCOv2 and single copy genes extracted. 
...
Since the publicly available MMETSP datasets, several studies have utilized a broader range of taxa to explore evolutionary stories involving the gonyaulacales. 
...
Maddison et. Knowles (2006) found that the amount of genetic information retains enough information to overcome extensive ILS when the number of genes is sufficient, in their study 27 genes were sufficient \cite{maddison2006inferring}. 
...
LBA in comparison is prone to be problematic in the deployment of less robust inference methods such as parsimony, however if the models are mispecified in ML or BI study this issue can occur also. %TODO expand section on LBA
...
Utilization of rDNA loci made sense when study designs were bound by sequencing and computational limitations, so they were a universally available proxy available. 
With the current level of sequencing technologies and the utilization of computing clusters now commonly available, we are no longer restricted to limited rDNA datasets as proxies for species evolution. 
