...
%good refs re orthology/parlogy
...
%TODO need to bring the non-messy-biologists up to speed on why the fuck gonyaulacales
...
%TODO insert processing scripts
...
BI was run in BEAST2 with the Gamma site model with 4 Gamma category counts under the WAG amino acid model. A local random clock was used and the priors were under the Birth Death model %TODO MATHIEU what was the end nuber of chains?
Both ML and BI inferences were run the HPCC. 

\subsection*{rDNA based tree comparison}
%TODO commit seppuku
Ribosomal DNA sequences for the small subunit region as well as the D1-D3 large subunit region were acquired from NCBI \cite{coordinators2017database} or the SILVA rRNA database project \cite{silvaproj}, accession IDs in Suppl. table 1. 
...
%TODO take out recoomendation for clades
...
%TODO tangelgram of rDNA vs single copy gene trees
