...
\paragraph*{Trimming RNA seq libraries}
\paragraph*{potential bias in single copy gene selection as based on BUSCO}
\paragraph*{assembly problems}
\paragraph*{WAG model}
\paragraph*{Molecular clock model selection}
\subsubsection*{Gonyaulacales specific issues}
\paragraph*{Not axenic}
