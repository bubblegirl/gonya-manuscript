...
\caption{Table S3: Accession numbers for ribosomal DNA sequences used for Fig. ~\ref{fig:rdna}. Sequences sourced from NCBI, except accesion numbers with $\ast$ sourced from the Silva database}\\
\hline
%\label{tbl:Transcriptomes}
%\textbf{Family}&
...
\hline
 ...
 \hline
\emph{Alexandrium catenella}&&\\
        \hline
\emph{Alexandrium monilatum}&&\\
        \hline
\emph{Ceratium fusus}&&\\
        \hline
\emph{Coolia malayensis}&&\\
\hline
\emph{Crypthecodinium cohnii}&&\\
        \hline
...
\multicolumn{3}{| c |}{Outgroup taxa}\\
    \hline
  \emph{Azadinium spinosum}&&\\
        \hline
\emph{Dinophysis acimunata}&&\\
        \hline
\emph{Karenia brevis}&&\\
\hline
\end{longtable}
