...
Two concerning phenomena that can creep in in phylogenetic studies based on the data set selected are incomplete lineage sorting (ILS) and long branch artifacts (LBA). 
